...
public interface DamageStrategy {
    ...
    void addBattle(String userId, String spreadsheetId, String damage, JDA jda);

    void addCarryover(Guild guild, String userId, String damage, JDA jda);

    void addCarryover(String userId, String spreadsheetId, String damage, JDA jda);

    void redoBattle(Guild guild, String userId, String damage, JDA jda);

    void redoBattle(String userId, String spreadsheetId, String damage, JDA jda);
