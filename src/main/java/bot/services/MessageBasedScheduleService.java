...
public class MessageBasedScheduleService {
    ...
    @Autowired
    public MessageBasedScheduleService(ScheduleRepository scheduleRepository, GuildRepository guildRepository, BossService bossService) {
    ...
    public MessageScheduleEntity getScheduleByGuildId(String guildId) {
    ...
    public void setChannelId(String guildId, String channelId) throws ScheduleDoesNotExistException {
        MessageScheduleEntity schedule = getScheduleByGuildId(guildId);
    ...
    public void createScheduleForGuild(String guildId) {
        GuildEntity guild = guildRepository.getGuildEntityByGuildId(guildId);
        MessageScheduleEntity schedule = new MessageScheduleEntity();
