...
public class GenerateUnitIDNameMap {
    public static UnitNameIDContext generate() {
        ...
        try {
            ...
            File englishFile = ResourceUtils.getFile("classpath:iconNameCSVs/english_names.csv");
            File japaneseFile = ResourceUtils.getFile("classpath:iconNameCSVs/japanese_names.csv");

            Scanner englishScanner = new Scanner(englishFile);
            Scanner japaneseScanner = new Scanner(japaneseFile, StandardCharsets.UTF_8);
